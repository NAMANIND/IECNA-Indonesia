...
import img from "../../../../public/images/home/venue-about.jpg";
  ...
  return (
    <>
      <p className={`text-md   text-white font-light   ${work_sans.className}`}>
        ...
        prestigious venue in Indonesia, providing a luxurious and conducive
        ...
        other in the heart of Indonesia's vibrant landscape.
      </p>
      <div
