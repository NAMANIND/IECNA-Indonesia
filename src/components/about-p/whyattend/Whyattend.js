...
function Whyattend() {
  const cardData = [
    ...
    },
    {
      title: "International\nPerspective",
      imageUrl: exclusive,
      text: "Indonesia attracts a diverse international audience. Engaging with attendees from different countries and cultures can provide a broader perspective on influencer marketing strategies and practices worldwide.",
    },
  ];
    ...
    >
      ...
      >
        <span className="font-semibold  italic">
          Indonesia We are back with The Influencer Exchange Confex & Awards
          Series 2.0
